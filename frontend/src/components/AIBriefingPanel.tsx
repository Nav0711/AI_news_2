...
import { type Article, type LanguageInfo, fetchLanguages, streamBriefing, streamFollowUp, streamTranslation } from "@/lib/api";
...
export default function AIBriefingPanel({ selectedArticle }: AIBriefingPanelProps) {
  ...
  return (
    <aside className="w-[420px] border-l border-border flex flex-col h-full">
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Gemini 1.5 Flash · 100 articles in context</p>
            </div>
          </div>
          ...
          <div className="animate-fade-in">
            ...
            {translation && (
              <div className="mt-4 pt-4 border-t border-border">
                <h4 className="text-[10px] font-mono-jet tracking-[0.2em] text-muted-foreground mb-2">TRANSLATION</h4>
                <div className="text-sm leading-relaxed text-secondary-foreground whitespace-pre-wrap">
                  {translation}
